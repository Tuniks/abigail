...
public class AzulejoConvoUICollage : MonoBehaviour{ 
    [Header("UI References")]
    public GameObject convoScreen;
    public GameObject tileSlot;
    public GameObject open;
    public GameObject close;
    public GameObject SigilNotActivated;
    public GameObject BodyStatic;
    ...
    public void HideNoSigil(){
        //SigilNotActivated.SetActive(true);
    }
